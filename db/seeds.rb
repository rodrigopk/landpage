Developer.create( name: "Rodrigo Vasconcelos de Barros", 
                  ...
                  picture: URI.parse("http://res.cloudinary.com/rodrigopk/image/upload/v1497703499/1/original/selfie.jpg"),
...
Developer.first.skills.create([
  { title: "Ruby on Rails",
    experience: 24,
    image: URI.parse("http://res.cloudinary.com/rodrigopk/image/upload/v1497703501/1/original/rails.png"),
  ...
  { title: "Swift",
    experience: 18,
    image: URI.parse("http://res.cloudinary.com/rodrigopk/image/upload/v1497703504/3/original/swift.png"),
  ...
  { title: "C++",
    experience: 12,
    image: URI.parse("http://res.cloudinary.com/rodrigopk/image/upload/v1497703506/4/original/c__.png"),
  ...
  { title: "Git",
    experience: 36,
    image: URI.parse("http://res.cloudinary.com/rodrigopk/image/upload/v1497703508/5/original/git.png"),
  ...
  { title: "Scrum",
    experience: 36,
    image: URI.parse("http://res.cloudinary.com/rodrigopk/image/upload/v1497703510/6/original/scrum.png"),
