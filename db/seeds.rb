Developer.create( name: "Rodrigo Vasconcelos de Barros", 
                  ...
                  picture: File.new("public/selfie.jpg"),
...
Developer.first.skills.create([
  { title: "Ruby on Rails",
    experience: 24,
    image: File.new("public/icons/rails.png"),
  ...
  { title: "angularJS",
    experience: 8,
    image: File.new("public/icons/angularjs.png"),
  ...
  { title: "Swift",
    experience: 18,
    image: File.new("public/icons/swift.png"),
  ...
  { title: "C++",
    experience: 12,
    image: File.new("public/icons/c++.png"),
  ...
  { title: "Git",
    experience: 36,
    image: File.new("public/icons/git.png"),
  ...
  { title: "Scrum",
    experience: 36,
    image: File.new("public/icons/scrum.png"),
